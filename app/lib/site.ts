...
export const PROJECTS: Project[] = [
  {
    slug: "austin-landscaping",
    client: "Austin Landscaping Co.",
    service: "Website + SEO",
    headline: "64% more enquiries in 90 days",
    metric: "64%",
    metricLabel: "More enquiries",
    image: "/images/portfolio/t6-featured.jpg",
    summary:
      "A hill country design-build crew with no search presence and a site that never sent them a single job.",
    detail: [
      "Austin Landscaping Co. were doing beautiful work and getting none of the credit for it online. Their old site was four years old, slow on a phone, and had no photography of their own builds on it.",
      "We rebuilt the site around their actual portfolio and wrote every service page for the suburbs they wanted to work in. Local SEO went in at the same time, so the pages had somewhere to rank.",
      "Ninety days after launch they were fielding enquiries from postcodes they had never worked in before, and the enquiries arrived already knowing the budget range.",
    ],
    outcomes: [
      { value: "64%", label: "More enquiries" },
  ...
  },
  {
    ...
    headline: "Under 60 second lead response",
    metric: "<60s",
    metricLabel: "Lead response",
    image: "/images/portfolio/t3-hero.jpg",
    summary:
      "Two owners on site all day, a phone nobody could answer, and enquiries quietly going to whoever picked up first.",
    detail: [
      "Amber & Oak were losing work they never knew about. Calls came in while both owners were on a job, went to voicemail, and the homeowner rang the next company on the list.",
      "The AI receptionist now answers every call and web enquiry, qualifies the job, and books it straight into the calendar. It knows their service area, their pricing bands, and what they do not take on.",
      "Since launch they have not missed a single call, and the average time between an enquiry landing and a human reply is under a minute.",
    ],
    outcomes: [
  ...
  {
    slug: "cedar-grounds",
    client: "Cedar Grounds Co.",
    service: "Full Package",
    headline: "3x more jobs booked every month",
    metric: "3x",
    metricLabel: "Jobs per month",
    image: "/images/portfolio/t4-hero.jpg",
    summary:
      "A grounds maintenance company with good crews, a weak brand, and no reliable way to fill next month.",
    detail: [
      "Cedar Grounds Co. took the full package: new site, local SEO, paid ads, and the AI receptionist running behind all of it.",
      "The site was built to make a five-person operation look like the established firm it actually is. Ads drove the top of the funnel while SEO built underneath it, and nothing that came in went unanswered.",
      "They now book three times the jobs per month they did before launch, and the pipeline stopped being seasonal guesswork.",
    ],
    outcomes: [
      { value: "3x", label: "Jobs per month" },
      { value: "4", label: "Services running" },
      { value: "24/7", label: "Lead capture" },
    ],
  },
  {
    slug: "green-valley",
    client: "Green Valley Lawn Care",
    service: "Paid Ads",
    headline: "12 jobs booked this month",
    metric: "12",
    metricLabel: "Jobs this month",
    image: "/images/portfolio/t1-hero.jpg",
    summary:
      "Ad spend was going out. Clicks were coming in. The landing page was throwing them away.",
    detail: [
      "Green Valley Lawn Care were already running ads when they came to us. The targeting was fine. The problem was everything after the click.",
      "We built a landing page for each service they advertise, matched to the ad that sends traffic to it, with the quote form above the fold and proof directly underneath.",
      "Same budget, same targeting, twelve jobs booked in the first full month.",
    ],
    outcomes: [
      { value: "12", label: "Jobs this month" },
      { value: "0", label: "Extra ad spend" },
      { value: "4", label: "Landing pages" },
    ],
  },
];
